...
func (r *RepoMongo) Create(ctx context.Context, item track.User) (track.User, error) {
...
func (r *RepoMongo) Update(ctx context.Context, item *track.User) error {
...
func (r *RepoMongo) Get(ctx context.Context, ID int64) (*track.User, error) {
	user, err := r.GetByField("tguser.id", ID)
	return &user, err
}

func (r *RepoMongo) List(ctx context.Context, filter track.UserFilter) (track.Users, error) {
