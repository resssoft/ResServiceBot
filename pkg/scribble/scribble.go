// Package scribble is a tiny JSON database //fixed: remove logger
package scribble
...
func New(dir string) (*Driver, error) {
	...
	if _, err := os.Stat(dir); err == nil {
		fmt.Println(fmt.Sprintf("Using '%s' (database already exists)\n", dir))
		return &driver, nil
	}

	// if the database doesn't exist create it
	fmt.Println(fmt.Sprintf("Creating scribble database at '%s'...\n", dir))
